...
function createEditForm(element) {
  ...
  const commentUser = element.getAttribute("data-comment-user");
  ...
  if (commentPhoto !== "") {
    editForm.innerHTML = `
  <form action="/comment/editUserComment/${postId}/${commentId}/${commentUser}?_method=PUT" enctype="multipart/form-data" method="POST">
